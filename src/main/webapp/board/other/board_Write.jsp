...
<body>
	<div class="main-preview">
		<form action="BoardWriteC" method="post" class="recruit" name="myForm" onsubmit="return checkBoard();">
			<input type="hidden" name="type" value="other">
			<h3 class="recruit__header">다른동물 게시글 작성</h3>
			<div class="recruit-content">
				<label for="" class="recruit-content__label">제목</label> 
				<input type="text" placeholder="ex) 자유롭게 작성해주세요."
					class="recruit-content__input recruit-content__input_full" name="title" />
					
				<label for="" class="recruit-content__label">내용</label>
				<textarea  rows="5" id="summernote" name="content"></textarea>
