...
fetch(url)
	...
	.then(data => {
		...
		for (var i = 0; i < cnt; i++) {
			...
			if ((data.data[i].축종).indexOf("고양이") != -1) {
				tabB += "<tr>";
				tabB += "<td>" + cnt2 + "</td>";
...
//http://api.odcloud.kr/api/15050442/v1/uddi:825b02de-f7ad-469a-b0ff-91b8e958c2df_201909241343?page=1&perPage=1528&serviceKey=Bko8yvz3KtGQk46gPKevjyb3G14HeLUyIxe9zAbgF50BrSG7DZ0%2FNqIrBLmNu%2Fbc3J%2FqFjbxBGAKuREN%2FPOAYg%3D%3D
//http://api.odcloud.kr/api/15050442/v1/uddi:825b02de-f7ad-469a-b0ff-91b8e958c2df_201909241343?page=1&perPage=1528&serviceKey=Bko8yvz3KtGQk46gPKevjyb3G14HeLUyIxe9zAbgF50BrSG7DZ0%2FNqIrBLmNu%2Fbc3J%2FqFjbxBGAKuREN%2FPOAYg%3D%3D