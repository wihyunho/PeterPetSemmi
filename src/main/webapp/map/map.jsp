...
#menu_wrap input{border-color: skyblue;
...
<div class="map_wrap">
    <div id="map" style="width:100%;height:100%;position:relative;overflow:hidden;"></div>
		<button id="categoryhidden" onclick="return false;" class="button">카테고리 접기/펼치기</button>
        ...
        <div class="option">
            ...
            <div>
                <form onsubmit="searchPlaces(); return false;">
                    키워드 : <input type="text" value="펫 샵" id="keyword" size="15"> 
                    <button type="submit" style="width: 60px; height: 20px;">검색하기</button> 
                </form> 
            </div>
        </div>
        <hr>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#categoryhidden").click(function() {
			status = $("#menu_wrap").css("display");
			if (status == "none") {
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=357f5f65e8c6ffad49f02e604361771b&libraries=services,clusterer"></script>
<script>
// 마커를 담을 배열입니다
var markers = [];
